...
/// File:        CRTTPCTruthEffMCKalman_module.cc
///
/// Author:         Tyler Boone
...
namespace icarus {
  ...
  class CRTTPCTruthEffMCKalman : public art::EDAnalyzer {
  public:

    explicit CRTTPCTruthEffMCKalman(fhicl::ParameterSet const & p);

    // The destructor generated by the compiler is fine for classes
    // without bare pointers or other resource use.

    // Plugins should not be copied or assigned.
    CRTTPCTruthEffMCKalman(CRTTPCTruthEffMCKalman const &) = delete;
    CRTTPCTruthEffMCKalman(CRTTPCTruthEffMCKalman &&) = delete;
    CRTTPCTruthEffMCKalman & operator = (CRTTPCTruthEffMCKalman const &) = delete; 
    CRTTPCTruthEffMCKalman & operator = (CRTTPCTruthEffMCKalman &&) = delete;
...
//    void reconfigure(fhicl::ParameterSet const & p);
  ...
  private:
	...
	//    uint64_t     m_gate_crt_diff;
	  ...
	  CRTTPCTruthEffMCKalman::CRTTPCTruthEffMCKalman(fhicl::ParameterSet const & p)
    ...
    fTpcTrackModuleLabel = p.get< std::vector<art::InputTag>>("TpcTrackModuleLabel", {"pandoraKalmanTrackGausCryoE","pandoraKalmanTrackGausCryoW"});
  ...
  } // CRTTPCTruthEffMCKalman()

/*
  void CRTTPCTruthEffMCKalman::reconfigure(fhicl::ParameterSet const & p)
  {
  ...
  } // CRTTPCTruthEffMCKalman::reconfigure()
*/

  void CRTTPCTruthEffMCKalman::beginJob()
  {
	...
	tr_crttpc->Branch("clearcosmic",&clearcosmic,"clearcosmic/O");
	  ...
	  } // CRTTPCTruthEffMCKalman::beginJob()

	  void CRTTPCTruthEffMCKalman::analyze(const art::Event & event)
	  {
...
//	      t0 = track_t0;   //Get T0
	  ...
	  std::vector<art::Ptr<recob::Hit>> hits = findManyHits.at(trackList[track_i].key() /*->ID()*/);
...
//	      	auto start = trackList[track_i]->Vertex<TVector3>();
  ...
  } // CRTTPCTruthEffMCKalman::produce()


void icarus::CRTTPCTruthEffMCKalman::GetAncestorID(int trueid, int &motherid, int &ancestorid, int &layers, std::map<int, simb::MCParticle> all_particles){
...
}//CRTTPCTruthEffMCKalman::GetAncestorID
void icarus::CRTTPCTruthEffMCKalman::getTickRange(std::vector<art::Ptr<recob::Hit>> hits, int &mintick, int &maxtick){
...
}//end definition of void icarus::CRTTPCTruthEffMCKalman::getTickRange(recob::Track trk, double &mintick, double &maxtick)

void icarus::CRTTPCTruthEffMCKalman::getCatCrossXYZ(recob::Track trk, double &my_x, double &my_y, double &my_z){
...
bool icarus::CRTTPCTruthEffMCKalman::willEnterCRTVolume(TVector3 vecpos, TVector3 vecdir, int crtregion){
...
}//end definition of bool icarus::CRTTPCTruthEffMCKalman::willEnterCRTVolume(TVector3 vecpos, TVector3 vecdir, int crtregion)

void icarus::CRTTPCTruthEffMCKalman::findIntersectingCRTVolume(TVector3 &vecpos, TVector3 &vecdir, int &likely_CRT_region1, int &likely_CRT_region2, int &likely_CRT_region3){
...
}//end definition of void icarus::CRTTPCTruthEffMCKalman::findIntersectingCRTVolume(recob::Track trk, TVector3 &retvec, TVector3 &endpoint, int &likely_CRT_region)

void icarus::CRTTPCTruthEffMCKalman::endpoint_PCA_ana(recob::Track trk, bool usestartpt, TVector3 &bestfit_dir, TVector3 &bestfit_pos){
...
void icarus::CRTTPCTruthEffMCKalman::pointChecker(recob::Track trk, bool &startisinTPC, bool &endisinTPC, int &startflag, int &endflag){
...
}//end definition of void icarus::CRTTPCTruthEffMCKalman::pointChecker(recob::Track trk, bool &startisinTPC, bool &endisinTPC)

double icarus::CRTTPCTruthEffMCKalman::getnewDCA(TVector3 CRTHitpos, TVector3 TPC_posvec, TVector3 TPC_dirvec){
...
}//end definition of double icarus::CRTTPCTruthEffMCKalman::getnewDCA(TVector3 CRTHitpos, TVector3 TPC_posvec, TVector3 TPC_dirvec)

float icarus::CRTTPCTruthEffMCKalman::vect_dist(TVector3 vec1, TVector3 vec2){
...
}//end definition of double icarus::CRTTPCTruthEffMCKalman::vect_dist(TVector3 vec1, TVector3 vec2)

double icarus::CRTTPCTruthEffMCKalman::CRT_plane_dist(TVector3 TPC_track_pos, TVector3 TPC_track_dir, TVector3 CRT_hit_pos, int plane_axis/*0 for x, 1 for y, 2 for z*/){
...
}//end double icarus::CRTTPCTruthEffMCKalman::CRT_plane_dist(TVector3 TPC_track_pos, TVector3 TPC_track_dir, TVector3 CRT_hit_pos, int plane_axis/*0 for x, 1 for y, 2 for z*/)


  DEFINE_ART_MODULE(CRTTPCTruthEffMCKalman)
