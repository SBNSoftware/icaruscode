...
std::map<int, std::vector<std::pair<geo::WireID, const sim::IDE*>>> RecoUtils::PrepSimChannels(const std::vector<art::Ptr<sim::SimChannel>> &simchannels, const geo::WireReadoutGeom &wireReadout) {
