...
namespace crt {
  class DecoderICARUSCRTNew;
}


class crt::DecoderICARUSCRTNew : public art::EDProducer {
public:
  explicit DecoderICARUSCRTNew(fhicl::ParameterSet const& p);
  // The compiler-generated destructor is fine for non-base
  // classes without bare pointers or other resource use.

  // Plugins should not be copied or assigned.
  DecoderICARUSCRTNew(DecoderICARUSCRTNew const&) = delete;
  DecoderICARUSCRTNew(DecoderICARUSCRTNew&&) = delete;
  DecoderICARUSCRTNew& operator=(DecoderICARUSCRTNew const&) = delete;
  DecoderICARUSCRTNew& operator=(DecoderICARUSCRTNew&&) = delete;
...
crt::DecoderICARUSCRTNew::DecoderICARUSCRTNew(fhicl::ParameterSet const& p)
  : EDProducer{p}
  , fInputTagPatterns{
  ...
  , fDropRawDataAfterUse{ p.get<bool>("DropRawDataAfterUse", true) }
{
  ...
  produces< std::vector<icarus::crt::CRTDataRaw> >();
...
bool crt::DecoderICARUSCRTNew::IsSideCRT(icarus::crt::BernCRTTranslator & hit) {
  /**
   * Fragment ID described in SBN doc 16111
   */
  return (hit.fragment_ID & 0x3100) == 0x3100;
}
void crt::DecoderICARUSCRTNew::CorrectForCableDelay(icarus::crt::BernCRTTranslator & hit) {
...
uint64_t crt::DecoderICARUSCRTNew::CalculateTimestamp(icarus::crt::BernCRTTranslator& hit) {
  /**
