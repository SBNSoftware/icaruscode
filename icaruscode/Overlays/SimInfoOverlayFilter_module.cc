...
private:
  ...
  std::vector<art::InputTag>    fSimEnergyDepositLiteInputModuleLabels;
  std::vector<art::InputTag>    fSimPhotonsLiteInputModuleLabels;
  std::vector<art::InputTag>    fOpDetBacktrackerRecordInputModuleLabels;
  std::vector<art::InputTag>    fAuxDetHitInputModuleLabels;
  ...
  CollectionMap< std::vector<sim::SimEnergyDepositLite> >   fSimEnergyDepositLiteMap;//Ivan
  CollectionMap< std::vector<sim::SimPhotonsLite> >   fSimPhotonsLiteMap;//Ivan
  CollectionMap< std::vector<sim::OpDetBacktrackerRecord> >   fOpDetBacktrackerRecordMap;//Ivan
  CollectionMap< std::vector<sim::AuxDetHit> >        fAuxDetHitMap;//Ivan
...
void mix::SimInfoOverlayFilter::FillInputModuleLabels(fhicl::ParameterSet const & p)
{
  ...
  FillInputModuleLabels(p,"SimEnergyDepositLiteInputModuleLabels",fSimEnergyDepositLiteInputModuleLabels); //Ivan
  FillInputModuleLabels(p,"SimPhotonsLiteInputModuleLabels",fSimPhotonsLiteInputModuleLabels); //Ivan
  FillInputModuleLabels(p,"OpDetBacktrackerRecordInputModuleLabels",fOpDetBacktrackerRecordInputModuleLabels); //Ivan
  FillInputModuleLabels(p,"AuxDetHitInputModuleLabels",fAuxDetHitInputModuleLabels); //Ivan
...
void mix::SimInfoOverlayFilter::DeclareProduces()
{
  ...
  DeclareProduces< std::vector<sim::SimEnergyDepositLite>      >(fSimEnergyDepositLiteInputModuleLabels); //Ivan
  DeclareProduces< std::vector<sim::SimPhotonsLite>      >(fSimPhotonsLiteInputModuleLabels); //Ivan
  DeclareProduces< std::vector<sim::OpDetBacktrackerRecord>      >(fOpDetBacktrackerRecordInputModuleLabels); //Ivan
  DeclareProduces< std::vector<sim::AuxDetHit>      >(fAuxDetHitInputModuleLabels); //Ivan
...
void mix::SimInfoOverlayFilter::InitializeCollectionMaps()
{
  ...
  InitializeCollectionMap(fSimEnergyDepositLiteInputModuleLabels,fSimEnergyDepositLiteMap); //Ivan
  InitializeCollectionMap(fSimPhotonsLiteInputModuleLabels,fSimPhotonsLiteMap); //Ivan
  InitializeCollectionMap(fOpDetBacktrackerRecordInputModuleLabels,fOpDetBacktrackerRecordMap); //Ivan
  InitializeCollectionMap(fAuxDetHitInputModuleLabels,fAuxDetHitMap); //Ivan
...
void mix::SimInfoOverlayFilter::PutCollectionsOntoEvent(art::Event & e)
{
  ...
  PutCollectionOntoEvent(e,fSimEnergyDepositLiteMap);
  PutCollectionOntoEvent(e,fSimPhotonsLiteMap);
  PutCollectionOntoEvent(e,fOpDetBacktrackerRecordMap);
  PutCollectionOntoEvent(e,fAuxDetHitMap);
...
bool mix::SimInfoOverlayFilter::filter(art::Event & e)
{
  ...
  FillCollectionMap<sim::SimEnergyDepositLite>(fSimEnergyDepositLiteInputModuleLabels,
                fSimEnergyDepositLiteMap,
                "std::vector<sim::SimEnergyDepositLite>",
                e);

  FillCollectionMap<sim::SimPhotonsLite>(fSimPhotonsLiteInputModuleLabels,
                fSimPhotonsLiteMap,
                "std::vector<sim::SimPhotonsLite>",
                e);

  FillCollectionMap<sim::OpDetBacktrackerRecord>(fOpDetBacktrackerRecordInputModuleLabels,
                fOpDetBacktrackerRecordMap,
                "std::vector<sim::OpDetBacktrackerRecord>",
                e);
 

  FillCollectionMap<sim::AuxDetHit>(fAuxDetHitInputModuleLabels,
                fAuxDetHitMap,
                "std::vector<sim::AuxDetHit>",
                e);
