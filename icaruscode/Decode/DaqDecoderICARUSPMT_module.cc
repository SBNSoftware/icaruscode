...
DaqDecoderIcarusPMT::DaqDecoderIcarusPMT(fhicl::ParameterSet const & param): 
...
DaqDecoderIcarusPMT::Config::Config(fhicl::ParameterSet const & param) 
{
...
*/
void daq::DaqDecoderIcarusPMT::process_fragment(art::Event &event, const artdaq::Fragment &frag, std::unique_ptr<std::vector<raw::RawDigit>> &product_collection) 
{
