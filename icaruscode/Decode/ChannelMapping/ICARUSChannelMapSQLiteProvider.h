...
class icarusDB::ICARUSChannelMapSQLiteProvider: public IICARUSChannelMap {
  ...
  using ChannelMappingAlg_t = icarusDB::ChannelMapSQLite;
  ...
  struct Config {
    ...
    fhicl::Atom<std::string> LogCategory{
      ...
      "ICARUSChannelMapSQLiteProvider" // default
      };
  ...
  ICARUSChannelMapSQLiteProvider(Config const& config);
  
  /// Constructor: configures the service provider via FHiCL configuration.
  ICARUSChannelMapSQLiteProvider(Parameters const& params)
    : ICARUSChannelMapSQLiteProvider{ params() }
    {}
...
}; // icarusDB::ICARUSChannelMapSQLiteProvider
