...
namespace icarusDB
{
  ...
  unsigned int ICARUSChannelMap::getSimMacAddress(const unsigned int hwmacaddress)  const
  {
    ...
    //if (fCRTChannelIDToHWtoSimMacAddressPairMap.first == hwmacaddress) return fCRTChannelIDToHWtoSimMacAddressPairMap.second;
    //    IChannelMapping::CRTChannelIDToHWtoSimMacAddressPairMap::const_iterator FEBBoardItr = fCRTChannelIDToHWtoSimMacAddressPairMap;
    ...
    //  IChannelMapping::CRTChannelIDToHWtoSimMacAddressPairMap::const_iterator FEBBoardItr;
    //return FEBBoardItr->second.second;
    // if (digitizItr == fFragmentToDigitizerMap.end())
    //unsigned int simmacadress =-99;
    //    for (FEBBoardItr = fCRTChannelIDToHWtoSimMacAddressPairMap.begin(); FEBBoardItr < fCRTChannelIDToHWtoSimMacAddressPairMap.end(); FEBBoardItr++)
    //if (FEBBoardItr->second.first == hwmacaddress) simmacadress = FEBBoardItr->second.second;
