/**
 * @file   icaruscode/Decode/Dumpers/BinaryDumpUtils.h
 * @brief  Functions to dump the content of binary data chunks to console
 * @author Gianluca Petrillo (petrillo@slac.stanford.edu)
 * @date   December 22, 2020
 */

#ifndef ICARUSCODE_DECODE_DUMPERS_BINARYDUMPUTILS_H
#define ICARUSCODE_DECODE_DUMPERS_BINARYDUMPUTILS_H
...
// -----------------------------------------------------------------------------
namespace sbn::data::dump::details {
...
namespace sbn::data::dump {
   ...
   * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~{.cpp}
   * std::cout << sbn::data::dump::bin(0xAA) << std::endl;
   * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   * 
   */
  /// @{
   ...
   * @see `sbn::data::dump::details::operator<< (std::ostream&, sbn::data::dump::details::BinObj<T, Bits> const&)`   * 
   * Example:
   * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~{.cpp}
   * std::cout << sbn::data::dump::bin(0xAA) << std::endl;
   * std::cout << sbn::data::dump::bin<char>(0xAA) << std::endl;
   * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   * Example:
   * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~{.cpp}
   * std::cout << sbn::data::dump::bin<10U>(0xAA) << std::endl;
   * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   * @see `sbn::data::dump::details::operator<< (std::ostream&, sbn::data::dump::details::HexDumper<Atom> const&)`
   * 
   * 
   * 
   * Only the least significant `Bits` will be printed.
   ...
   * std::cout << sbn::data::dump::hexdump(data, 7U, 8U) << std::endl;
   * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   * std::cout << sbn::data::dump::hexdump(powers, 13U, 8U) << std::endl;
   * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   * Example:
   * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~{.cpp}
   * std::cout << sbn::data::dump::zeropad(79, 4) << std::endl;
   * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~{.cpp}
   * will print `0079` while
   * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~{.cpp}
   * std::cout << std::hex << sbn::data::dump::zeropad(79, 4, '*') << std::endl;
   * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~{.cpp}
   * will print `**4F`.
   */
  template <typename T>
 ...
 * {
 *   sbn::data::dump::FormatFlagsGuard sg(std::cout); // saves std::cout status
 ...
 */
template <typename IOS>
class sbn::data::dump::FormatFlagsGuard {
...
}; // struct sbn::data::dump::FormatFlagsGuard


// -----------------------------------------------------------------------------
template <typename T>
constexpr T sbn::data::dump::details::fourMSBmask() {
  static_assert(std::is_integral_v<T>);
  T mask { 0x0F };
  while (T shifted = mask << 4U) mask = shifted;
  return mask;
} // sbn::data::dump::details::fourMSBmask()


// -----------------------------------------------------------------------------
template <unsigned int N, char C = ' '>
std::ostream& sbn::data::dump::details::operator<<
  (std::ostream& out, Blanks<N, C>)
{
  for (unsigned int i = 0U; i < N; ++i) out.put(C);
  return out;
} // sbn::data::dump::details::operator<< (sbn::data::dump::details::Blanks)
  ...
  (std::ostream& out, BinObj<T, Bits> const& data)
{
  ...
  return out;
} // sbn::data::dump::details::operator<< (sbn::data::dump::details::BinObj)
  ...
  (std::ostream& out, HexObj<T> const& data)
{
  ...
  constexpr T nibbleMask = fourMSBmask<T>(); // the four most significant bits
  while (nibblesLeft--) {
    out << HexChars[value & nibbleMask];
    value << 4U;
  } // while
  return out;
} // sbn::data::dump::details::operator<< (sbn::data::dump::details::HexObj)
  ...
  (std::ostream& out, HexDumper<Atom> const& data)
{
  ...
  auto const printAtoms = [&out]
    (Atom const* ptr, Atom const* const ptrend, std::ptrdiff_t columns)
    {
      ...
      while (ptr != cend) {
        out << ' ';
        if (ptr < ptrend) out << std::setw(AtomChars) << *ptr;
        else              out << BlankAtom;
        ++ptr;
      } // while
      return ptr;
...
} // sbn::data::dump::details::operator<< (ZeroPadder)



// -----------------------------------------------------------------------------
template <typename T>
constexpr auto sbn::data::dump::bin(T value) -> details::BinObj<T>
  { return details::BinObj<T>{ std::move(value) }; }

template <std::size_t Bits, typename T>
constexpr auto sbn::data::dump::bin(T value) -> details::BinObj<T, Bits>
  { return details::BinObj<T, Bits>{ std::move(value) }; }


// -----------------------------------------------------------------------------
template <typename Atom>
auto sbn::data::dump::hexdump
  (Atom const* data, std::size_t size, unsigned int columns /* = 16U */)
...
// -----------------------------------------------------------------------------
template <typename T>
auto sbn::data::dump::zeropad(T data, unsigned int field, char pad /* = '0' */)
...
#endif // ICARUSCODE_DECODE_DUMPERS_BINARYDUMPUTILS_H
