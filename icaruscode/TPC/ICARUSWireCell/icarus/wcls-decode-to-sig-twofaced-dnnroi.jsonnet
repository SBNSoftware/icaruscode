...
local wcls_output = {
  ...
  sp_signals: g.pnode({
    ...
    data: {
      ...
      frame_tags: ['gauss', 'wiener', 'looseLf', 'dnnsp'],
      frame_scale: [std.extVar('gain_ADC_per_e'), std.extVar('gain_ADC_per_e'), std.extVar('gain_ADC_per_e'), std.extVar('gain_ADC_per_e')],
