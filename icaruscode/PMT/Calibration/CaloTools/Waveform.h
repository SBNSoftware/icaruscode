...
namespace pmtcalo
{
  ...
  class Waveform
  {
      ...
      private:
        ...
        double adc_to_mV = 0.122; // CONFIGURED EXTERNALLY 
        double adc_to_pC = adc_to_mV*2.0*0.02; // CONFIGURURED EXTERALLY 
        double m_sampling_period = 2.0; // in ns (TAKEN EXTERNALLY FROM SERVICES)
