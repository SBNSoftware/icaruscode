#ifndef LCVN_ICARUSICVNMAPPER_H
#define LCVN_ICARUSICVNMAPPER_H
...
namespace lcvn {
  ...
  class ICARUSICVNMapper : public art::EDProducer {
  public:
    explicit ICARUSICVNMapper(fhicl::ParameterSet const& pset);
