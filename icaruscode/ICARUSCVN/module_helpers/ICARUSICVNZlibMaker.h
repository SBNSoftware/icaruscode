#ifndef LCVN_ICARUSICVNZLIBMAKER_H
#define LCVN_ICARUSICVNZLIBMAKER_H
...
namespace lcvn {
  ...
  class ICARUSICVNZlibMaker : public art::EDAnalyzer {
  public:
    explicit ICARUSICVNZlibMaker(fhicl::ParameterSet const& pset);
    ~ICARUSICVNZlibMaker();
