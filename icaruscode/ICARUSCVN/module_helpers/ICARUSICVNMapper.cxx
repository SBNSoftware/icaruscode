...
namespace lcvn
{
  template <class T, class U> ICARUSICVNMapper<T, U>::ICARUSICVNMapper(fhicl::ParameterSet const& pset)
    : EDProducer{pset}
...
template <class T, class U> void ICARUSICVNMapper<T, U>::produce(art::Event& evt)
{
   if(fverbose) std::cout << "============ Calling the function ICARUSICVNMapper::produce() ==============\n";
   
   if(fUseSlice){
      if(fverbose) std::cout << "============ Calling the function ICARUSICVNMapper::produce() is using slices ==============\n";
	  ...
	  if(pfp_T0_vec.size()){
	     ...
	     PixelMap pm = fProducer.ICARUSCreateMap(detProp, slicehits);
   ...
   ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
       ...
       if(fverbose) std::cout << "============ Calling the function ICARUSICVNMapper::produce() is using full event ==============\n";
       ...
       auto const detProp = art::ServiceHandle<detinfo::DetectorPropertiesService const>()->DataFor(evt);
       PixelMap pm = fProducer.ICARUSCreateMap(detProp, hitlist);
       auto nhits = fProducer.TotHits();
       pm.SetTotHits(nhits);
