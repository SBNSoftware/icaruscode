...
void CandHitICARUS::configure(const fhicl::ParameterSet& pset)
{
    ...
    fInd1Multi = pset.get< double  >("Ind1Multi");
    fInd2Multi = pset.get< double  >("Ind2Multi");
    fColMulti = pset.get< double  >("ColMulti");
    fInd1100kHz = pset.get< double  >("Ind1100kHz");
    fInd2100kHz = pset.get< double  >("Ind2100kHz");
    fCol100kHz = pset.get< double  >("Col100kHz");
    fInd1Isolated = pset.get< double  >("Ind1Isolated");
    fInd2Isolated = pset.get< double  >("Ind2Isolated");
    fColIsolated = pset.get< double  >("ColIsolated");
    fInd1RMS = pset.get< double  >("Ind1RMS");
    fInd2RMS = pset.get< double  >("Ind2RMS");
    fColRMS = pset.get< double  >("ColRMS");
